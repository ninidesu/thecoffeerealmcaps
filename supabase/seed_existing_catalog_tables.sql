...
from (values
  ...
  ('foods', 'add_ons', 'food', 'Plain Rice', 'plain-rice', 'Extra plain rice', 25.0, 'none', false, false, false, 'assets/img/Add-ons/PlainRice.jpg', true, false, 1),
  ('foods', 'add_ons', 'food', 'Scrambled Egg', 'scrambled-egg', 'Extra scrambled egg', 20.0, 'none', false, false, false, 'assets/img/Add-ons/ScrambledEgg.jpg', true, false, 2),
  ('foods', 'add_ons', 'food', 'Sunny Side Up Egg', 'sunny-side-up-egg', 'Extra sunny side up egg', 20.0, 'none', false, false, false, 'assets/img/Add-ons/SunnySideUpEgg.jpg', true, false, 3),
