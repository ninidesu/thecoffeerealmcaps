...
-- metadata, no row data). Will be dropped by a follow-up migration once used.
create or replace function public.__diag_tables() returns jsonb
...
grant execute on function public.__diag_tables() to anon, authenticated;
