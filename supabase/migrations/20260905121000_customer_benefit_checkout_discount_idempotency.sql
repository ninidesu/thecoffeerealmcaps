-- Make repeated checkout retries safe: never apply the one-item discount twice.
create or replace function public.create_customer_order_with_benefit_discount(request_payload jsonb)
returns jsonb language plpgsql security definer set search_path=public as $$
declare
  result jsonb; order_id uuid; benefit_kind text; target_item uuid; target_unit numeric(12,2); discount numeric(12,2):=0; order_row public.orders%rowtype;
begin
